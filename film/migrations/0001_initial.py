    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('yanyuan', models.TextField(default='', max_length=255, verbose_name='演员')),
                ('category', models.CharField(default='', max_length=255, verbose_name='电影类型')),
                ('guojia', models.CharField(default='', max_length=255, verbose_name='国家/地区')),
                ('chupingongsi', models.TextField(default='', max_length=255, verbose_name='出品公司')),
                ('zhipiangongsi', models.TextField(default='', max_length=255, verbose_name='制片公司')),
                ...
                ('db_fen', models.FloatField(default=0, verbose_name='豆瓣评分')),
                ('imdb_fen', models.FloatField(default=0, verbose_name='IMDB评分')),
